      ...
      <div className="absolute -inset-12 z-0 rounded-2xl">
        ...
        <div 
          ...
          style={{
            ...
            WebkitMask: 'linear-gradient(to right, rgba(0,0,0,0.8) 0%, rgba(0,0,0,0.4) 40%, transparent 80%)',
          }}
        />
        ...
        <div 
          ...
          style={{
            ...
            WebkitMask: 'linear-gradient(to right, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.2) 50%, transparent 90%)',
          }}
        />
        {/* Слой с легким blur */}
        <div 
          ...
          style={{
            ...
            WebkitMask: 'linear-gradient(to right, rgba(0,0,0,0.4) 0%, rgba(0,0,0,0.1) 60%, transparent 95%)',
          }}
        />
        ...
        <div 
          className="absolute inset-0 rounded-2xl"
          style={{
            background: 'linear-gradient(to right, rgba(0,0,0,0.3) 0%, rgba(0,0,0,0.1) 30%, transparent 70%)',
          }}
        />
      </div>
